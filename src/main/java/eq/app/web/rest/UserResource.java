...
import eq.app.domain.Authority;
import eq.app.domain.User;
import eq.app.repository.AuthorityRepository;
import eq.app.repository.UserRepository;
import eq.app.security.AuthoritiesConstants;
import eq.app.service.MailService;
import eq.app.service.UserService;
import eq.app.web.rest.dto.ManagedUserDTO;
import eq.app.web.rest.dto.UserDTO;
import eq.app.web.rest.util.HeaderUtil;
import eq.app.web.rest.util.PaginationUtil;
